...
def payment():
    ...
    unpaid_orders = config_app.get_unpaid_orders()
    target_order = None
...
def redeem_code():
    ...
    redeem_codes = config_app.get_redeem_codes()
    ...
    for redeem_code_obj in redeem_codes:
        if redeem_code_obj['code'] == code and not redeem_code_obj['used']:
            ...
            config_app.add_recharge_history(f'REDEEM-{code}', redeem_amount, 'redeemed')
